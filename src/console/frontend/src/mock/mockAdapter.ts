...
const MOCK_APPS_RELEASES = {
  ...
  packages: [
    _mockPkg(
      ...
      "exe",
      "インストーラー (.exe)",
      `CivilPDF-Editor-Setup-${_APP_VER}.exe`,
      "87.4 MB",
    ),
    _mockPkg(
      "win-msi",
    ...
    _mockPkg(
      ...
      "zip",
      "ポータブル (.zip)",
      `CivilPDF-Editor-Portable-${_APP_VER}.zip`,
      "94.1 MB",
    ),
    _mockPkg(
      "mac-dmg",
    ...
    _mockPkg(
      ...
      "intunewin",
      "Intune パッケージ",
      `CivilPDF-Editor-${_APP_VER}.intunewin`,
      "91.2 MB",
    ),
  ],
  channels: [
