...
Phase 5.1 コンプライアンス基盤まで実装済み。ユニットテスト 157 件・E2E テスト 20 件・フロントエンドテスト 74 件、CI カバレッジ 98%。
...
| Frontend（Vitest） | 74 件 | — | `cd src/console/frontend && npx vitest run` |
| **合計** | **251 件** | — | — |
...
| Phase 5 | OCR / AI（文書要約・自動分類・テキスト抽出高度化） | 📋 未着手 |
| Phase 6 | GUI アプリ（Windows デスクトップ PDF エディタ） | 📋 未着手 |
