...
# Real asset filenames as attached to GitHub Release v1.1.0. Filenames are derived
# from the version field in package.json / tauri.conf.json / Cargo.toml (all "1.1.0").
# GitHub replaces spaces with dots. Download URLs are `{base}/{filename}`.
